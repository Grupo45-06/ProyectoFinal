...
export default {
  ...
  methods: {
    ...
    list() {
      axios
        .get("http://localhost:4000/api/categoria/list")
        .then((response) => {
          // handle success
    ...
    deleteItemConfirm() {
      ...
      if (this.editedItem.estado === 1) {
        axios.put('http://localhost:4000/api/categoria/disabled', {
        ...
        axios.put('http://localhost:4000/api/categoria/enabled', {
          _id: this.editedItem._id
        })
        .then(response => {
          this.list();
    ...
    save() {
      if (this.editedIndex > -1) {
        ...
        // Object.assign(this.categorias[this.editedIndex], this.editedItem);
          axios.put('http://localhost:4000/api/categoria/update', {
        ...
        axios.post('http://localhost:4000/api/categoria/add', {
          nombre: this.editedItem.nombre,
          descripcion: this.editedItem.descripcion,
        })
        .then(response => {
